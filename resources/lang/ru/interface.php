...
//    'remaining_time' => 'Осталось времени: :time',
    ...
    'started' => 'Запущена',
    'not_started' => 'На старте',
    'finished' => 'Завершено',
    'not_finished' => 'Не завершено',
    'status' => 'Статус',
    'reports' => 'Отчеты',
    'value' => 'Значение',
    'remaining_time' => 'Уважаемый кандидат, на решение 1 ситуационной задачи Вам предоставляется  15 минут.',
    ...
    'report_results' => 'Результаты оценки компетенций',
    'report_individual' => 'Индивидуальный отчет по результатам проведённой оценки',
    'report_plan' => 'Индивидуальный план развития',
    'report_compare' => 'Сравнение с профилем компетенций',
    'subject_to_learn' => 'Тема изучения',
//    '' => '',
//    '' => '',
