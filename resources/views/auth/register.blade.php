                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? 'errors' : '' }}">
                            <label for="name" class="col-md-4 control-label">{!! trans('interface.name') !!}</label>
                        ...
                        <div class="form-group{{ $errors->has('iin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="iin" type="text" pattern="\d{12}"  class="form-control" name="iin" value="{{ old('iin') }}" >
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">{!! trans('interface.confirm_password') !!}</label>
